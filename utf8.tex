...
\usepackage{fancyhdr}
\usepackage[top=3cm, bottom=2.5cm, left=2.5cm, right=2.5cm, head=0.5cm, headsep=0.5cm, foot=0.75cm]{geometry}
...
\title{\includegraphics[scale=.25]{PearLogo.eps} \\The PRCToken Whitepaper}

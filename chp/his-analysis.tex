\chapter{Historical Analysis}\label{sec-his-analysis}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1.00\textwidth]{figure/his-analysis/p2p_fail_analysis.pdf}
...
\begin{enumerate}
	...
	%			\includegraphics[width=0.48\linewidth]{figure/his-analysis/visc_engergy.png} 
	%		} 
	%		\subfigure { \label{fig:spec-cpu-performance} 
	%			\includegraphics[width=0.48\linewidth]{figure/his-analysis/visc_single_thread.png} 
	%		}
	...
	\begin{figure}[ht] 
		\centering 
		\input{figure/his-analysis/arm_apple_intel}
	...
	%			\input{figure/his-analysis/arm-cortex-cpu}
	%			%\includegraphics[width=0.46\linewidth]{figure/his-analysis/arm_cortex_a7_a15.jpg} 
	%		} 
	%		%\subfigure[Performance vs. power of nVIDIA CPUs.] { \label{fig:nvidia-pp-gtx} 
	%		%	\includegraphics[width=0.50\linewidth]{figure/his-analysis/gtx_gpu.jpg} 
	%		%}
	%		\subfigure[Performance vs. power of nVIDIA CPUs.] { \label{fig:nvidia-pp-gtx} 
	%			\input{figure/his-analysis/gtx-gpu}
	%		}
	...
	\begin{figure}[ht] 
		...
		\subfigure[Tech-independent average power normalized to A8.] { \label{fig:tech-independent-avg-power} 
			\includegraphics[width=0.44\linewidth]{figure/his-analysis/avg-power_to_a8.png} 
		} 
		\subfigure[Power performance tradeoffs.] { \label{fig:power-performance-tradeoffs} 
			\includegraphics[width=0.52\columnwidth]{figure/his-analysis/power-performance_tradeoffs.png} 
		}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.75\textwidth]{figure/webrtc/web_evolution.pdf}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1.00\textwidth]{figure/webrtc/webrtc_timeline.pdf}
